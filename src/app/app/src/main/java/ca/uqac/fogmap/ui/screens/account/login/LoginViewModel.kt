package ca.uqac.fogmap.ui.screens.account.login

import androidx.compose.runtime.mutableStateOf
import androidx.lifecycle.ViewModel
import ca.uqac.fogmap.common.state.ErrorState
import ca.uqac.fogmap.ui.screens.account.login.state.LoginErrorState
import ca.uqac.fogmap.ui.screens.account.login.state.LoginState
import ca.uqac.fogmap.ui.screens.account.login.state.LoginUiEvent
import ca.uqac.fogmap.ui.screens.account.login.state.emailOrMobileEmptyErrorState
import ca.uqac.fogmap.ui.screens.account.login.state.passwordEmptyErrorState
